...
async def get_shortlink(chat_id, link):
    ...
    if 'shortlink' in settings.keys():
        ...
        URL = SHORTLINK_URL
        API = SHORTLINK_API
    if URL.startswith("shorturllink") or URL.startswith("terabox.in") or URL.startswith("urlshorten.in") or URL.startwith("yamlinks.com"):
        URL = SHORTLINK_URL
        API = SHORTLINK_API
                    ...
                    await bot.send_cached_media(
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            [
                                ...
                                InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="https://t.me/TheBlackXYZBotz")
                                ]
                            ]
                        )
                    )
